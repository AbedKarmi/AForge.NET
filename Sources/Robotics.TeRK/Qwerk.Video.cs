...
namespace AForge.Robotics.TeRK
{
    ...
    public partial class Qwerk
    {
        ...
        public class Video : IVideoSource
        {
            ...
            private readonly TeRKIceLib.VideoStreamerServerPrx videoStreamer = null;
                ...
                while ( !stopEvent.WaitOne( 0, false ) )
                {
                    try
                    {
                        ...
                        while ( !stopEvent.WaitOne( 0, false ) )
                        {
                            ...
                            {
                                VideoSourceError?.Invoke(this, new VideoSourceErrorEventArgs("Video frame has unsupported format: " + qwerkImage.format));
                            }
                    ...
                    {
                        VideoSourceError?.Invoke(this, new VideoSourceErrorEventArgs("Failed getting video frame from Qwerk."));
                    }
                }
